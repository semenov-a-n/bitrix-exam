            ...
            if ($arResult["nStartPage"] <= 2 || $arResult["NavPageCount"] - $arResult["nStartPage"] <= 1 || abs($arResult['nStartPage'] - $arResult["NavPageNomer"]) <= 2) {
                ...
                if ($arResult["nStartPage"] == $arResult["NavPageNomer"]):
                    ...
                    <a href="javascript:void(0)"
                       onclick="<?= $arParams["HANDLER"] ?>(<?= $arResult["nStartPage"] ?>); return false;"><?= $NavRecordGroupPrint ?></a>
                    <?
                endif;
                $bFirst = false;
                $bPoints = true;
            ...
            do {
                if ($arResult["nStartPage"] <= 2 || $arResult["nEndPage"] - $arResult["nStartPage"] <= 1 || abs($arResult['nStartPage'] - $arResult["NavPageNomer"]) <= 2) {
                    ...
                    if ($arResult["nStartPage"] == $arResult["NavPageNomer"]):
                        ...
                        ?>
                        <a href="javascript:void(0)"
                           onclick="<?= $arParams["HANDLER"] ?>(<?= $arResult["nStartPage"] ?>); return false;"><?= $arResult["nStartPage"] ?></a>
                        <?
                    endif;
                    $bFirst = false;
                    $bPoints = true;
